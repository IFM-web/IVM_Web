...
const EmployeeList = () => {
    $.ajax({
        url: localStorage.getItem("Url") + "/AdminArea/GetEmployeesingle",
        type: "Get",
        data: { Id: $("#EMpId").val()},
        success: (resp) => {
...
const Insert = () => {
    ...
    $.ajax({
        url: localStorage.getItem("Url") + "/AdminArea/InsertEmployee",
        type: "Post",
        data: {
            EmpId: $("#EMpId").val(),
            EName:  $("#txtEName").val(),
        ...
        success: (resp) => {
            ...
            window.location.href = localStorage.getItem("Url") + "/AdminArea/EmployeeList"
