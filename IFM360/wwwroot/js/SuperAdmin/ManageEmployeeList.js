...
const EmployeeList = () => {
    $.ajax({
        url: localStorage.getItem("Url") + "/SuperAdmin/GetEmployeeList",
        type: "Get",
        data: {},
        success: (resp) => {
            ...
            for (let i in result) {
                ...
                <td> <a class="btn btn-success" href="${localStorage.getItem("Url")}/SuperAdmin/Employee/${result[i].employee_id}")">Edit</a>
